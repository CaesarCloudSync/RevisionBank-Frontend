...
export default function ManageRevisionCardsChange(props:any){
    ...
    const changeImage = async () =>{
        ...
        const response = await axios.post("http://127.0.0.1:8080/managechangecardimage",json_data,config)
    ...
    const removeImage = async () =>{
        ...
        const response = await axios.post("http://127.0.0.1:8080/manageremovecardimage",json_data,config)
        console.log(response.data)
