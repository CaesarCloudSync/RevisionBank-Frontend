...
export default function AccountPage(){
    ...
    const getaccountinfo = async (token:any) => {
        ...
        const response:any = await axios.get(`https://revisionbank.onrender.com/getaccountinfo`,config); // Send login post request.
    ...
    const getstudentsubscriptions = async (token:any) => {
        const config = {headers: {Authorization: `Bearer ${token}`,}}
        const response:any = await axios.get(`https://revisionbank.onrender.com/getstudentsubscriptions`,config)
