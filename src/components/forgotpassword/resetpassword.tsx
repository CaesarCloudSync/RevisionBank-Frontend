...
export default function ResetPassword(){
    ...
    const resetpassword = async (event:any) => { 
        ...
        if (newpassword === confirmnewpassword){
            ...
            const response:any = await axios.put(`http://127.0.0.1:8080/resetpassword`, {"password":newpassword},config); // Send login post request.
...
//const responsegettoken:any = await axios.get(`http://127.0.0.1:8080/getforgotpasswordtoken`,config); // Send login post request.
