...
export default function ResetPassword(){
    ...
    const resetpassword = async (event:any) => { 
        ...
        if (newpassword === confirmnewpassword){
            ...
            const response:any = await axios.put(`https://revisionbankbackend-aoz2m6et2a-uc.a.run.app/resetpassword`, {"password":newpassword},config); // Send login post request.
...
//const responsegettoken:any = await axios.get(`https://revisionbankbackend-aoz2m6et2a-uc.a.run.app/getforgotpasswordtoken`,config); // Send login post request.
