...
export default function ForgotPassword(){
    ...
    const forgotpassword = async (event:any) => { 
        ...
        const response:any = await axios.post(`https://revisionbankbackendsql-aoz2m6et2a-uc.a.run.app/forgotpassword`, {"email":email.toLowerCase()}); // Send login post request.
