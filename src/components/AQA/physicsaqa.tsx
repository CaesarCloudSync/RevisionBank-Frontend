...
export default function PhysicsAqa (){
    ...
    const sendApi = async (e:any) => {
      ...
      const response:any = await axios.post("http://192.168.0.22:8080/physicsaqa",{"physicsaqa":{"email":email,"chapter":physicsaqachapter.label ,"topic":physicsaqatopic.label,"platform":"web"}},config)
