...
export default function PhysicsAqa (){
    ...
    const sendApi = async (e:any) => {
      ...
      const response:any = await axios.post("https://revisionbankbackend-qqbn26mgpa-uc.a.run.app/physicsaqa",{"physicsaqa":{"email":email,"chapter":physicsaqachapter.label ,"topic":physicsaqatopic.label,"platform":"web"}},config)
