...
export default function ComputerScienceAQA(){
    ...
    const sendApi = async (e:any) => {
      ...
      const config = {headers: {Authorization: `Bearer ${token.token}`}}
      //console.log(config)
      const responsaqacompscienceqp:any =  await axios.post("https://revisionbankbackendsql-aoz2m6et2a-uc.a.run.app/getcomputerscienceqp",json,config)
    ...
    const sendApiMS = async (e:any) => {
      ...
      const config = {headers: {Authorization: `Bearer ${token.token}`}}
      //console.log(config)
      const responsaqacompsciencems:any =  await axios.post("https://revisionbankbackendsql-aoz2m6et2a-uc.a.run.app/getcomputersciencems",json,config)
