...
export default function ComputerScienceAQA(){
    ...
    const sendApi = async (e:any) => {
      ...
      const config = {headers: {Authorization: `Bearer ${token.token}`}}
      //console.log(config)
      const responsaqacompscienceqp:any =  await axios.post("https://revisionbank.onrender.com/getcomputerscienceqp",json,config)
    ...
    const sendApiMS = async (e:any) => {
      ...
      const config = {headers: {Authorization: `Bearer ${token.token}`}}
      //console.log(config)
      const responsaqacompsciencems:any =  await axios.post("https://revisionbank.onrender.com/getcomputersciencems",json,config)
