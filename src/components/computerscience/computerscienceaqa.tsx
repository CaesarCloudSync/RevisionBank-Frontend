...
export default function ComputerScienceAQA(){
    ...
    const sendApi = async (e:any) => {
      ...
      const config = {headers: {Authorization: `Bearer ${token.token}`}}
      //console.log(config)
      const responsaqacompscienceqp:any =  await axios.post("http://192.168.0.22:8080/getcomputerscienceqp",json,config)
    ...
    const sendApiMS = async (e:any) => {
      ...
      const config = {headers: {Authorization: `Bearer ${token.token}`}}
      //console.log(config)
      const responsaqacompsciencems:any =  await axios.post("http://192.168.0.22:8080/getcomputersciencems",json,config)
